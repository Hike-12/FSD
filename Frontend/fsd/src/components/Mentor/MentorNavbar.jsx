          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-bold">Mentor Portal</span>
              </div>
            </div>

            <div className="flex items-center space-x-10">
              <nav className="hidden md:flex space-x-6 place-items-center">
                <a href="/mentor-dashboard" className="text-[#A0AEC0] hover:text-white transition-colors">
                  Dashboard
                </a>
                <a href="/mentor-competitions" className="text-[#A0AEC0] hover:text-white transition-colors">
                  Competitions
                </a>
                <a href="/mentor-profile" className="text-[#A0AEC0] hover:text-white transition-colors">
                  Profile
                </a>
              </nav>
