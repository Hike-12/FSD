...
import { X, LogOut, Trophy, Users, User } from "lucide-react";
          ...
          <div className="flex items-center justify-between p-4">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white font-bold">Host Portal</span>
              </div>
            </div>

            <div className="flex items-center space-x-10">
              <nav className="hidden md:flex space-x-6 place-items-center">
                <a href="/host-dashboard" className="text-[#A0AEC0] hover:text-white transition-colors">
                  Dashboard
                </a>
                <a href="/host-competitions" className="text-[#A0AEC0] hover:text-white transition-colors">
                  Competitions
                </a>
                <a href="/host-profile" className="text-[#A0AEC0] hover:text-white transition-colors">
                  Profile
                </a>
              </nav>
          ...
          <div className="w-64 h-full bg-[#0A0A0A]/95 backdrop-blur-md border-l border-[#1F2A2A] shadow-xl">
            ...
            <div className="p-4">
              <nav className="space-y-2">
                <a href="/host-profile" className="flex items-center py-2 px-4 text-white bg-[#121F1F] rounded-lg hover:bg-[#00C4B8]/10 transition-colors">
                  <User className="w-5 h-5 mr-3" />
                  Profile
                </a>
                <a href="/host-competitions" className="flex items-center py-2 px-4 text-[#A0AEC0] hover:text-white hover:bg-[#00C4B8]/10 rounded-lg transition-colors">
