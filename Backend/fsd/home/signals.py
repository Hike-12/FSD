...
from .models import CustomUser, MentorProfile, StudentProfile, Host
...
def create_mentor_profile(sender, instance, created, **kwargs):
    ...
    elif created and instance.role == 'HOST':  # New condition for HOST role
        Host.objects.create(user=instance, full_name=instance.get_full_name())